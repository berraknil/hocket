...
test.describe("Session Command Dialog", () => {
  ...
  test("should filter commands when typing in search", async ({ page }) => {
    ...
    await expect(page.locator('[cmdk-item]:has-text("Add Pane")')).toBeVisible({
      timeout: 5000,
    });
  });
  ...
  test("should show session commands", async ({ page }) => {
    ...
    await expect(
      page.locator('[cmdk-item]:has-text("New")').first(),
    ).toBeVisible({ timeout: 5000 });
  });
...
test.describe("Layout Management", () => {
  ...
  test("should show remove pane command", async ({ page }) => {
    ...
    await expect(page.locator("text=Remove Pane")).toBeVisible({
      timeout: 5000,
    });
  });
  ...
  test("should show configure layout command", async ({ page }) => {
    ...
    await expect(
      page.locator('[cmdk-item]:has-text("Configure")').first(),
    ).toBeVisible({ timeout: 5000 });
  });
...
test.describe("Display Settings", () => {
  test("should show display settings command", async ({ page }) => {
    ...
    await expect(
      page
        .locator("text=Display Settings")
        .or(page.locator("text=Change Display Settings")),
    ).toBeVisible({ timeout: 5000 });
  });
});
